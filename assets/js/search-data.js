    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-have-been-awarded-an-nwo-veni-grant-to-work-on-mechanistic-interpretability-for-graph-ml-models",
          title: 'I have been awarded an NWO Veni grant to work on mechanistic interpretability...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61.%6C%75%63%69%63@%75%76%61.%6E%6C", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=tQPUCysAAAAJ&hl", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/a-lucic", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ana-lucic-uva", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/__alucic", "_blank");
        },
      },];
